...
if __name__ == "__main__":
    ...
    a_values_from_distance = calculate_scale_factor_from_cMpc(distances, cosmology)
    distances_from_a_values = calculate_cMpc_from_scale_factor(scale_factors, cosmology)
