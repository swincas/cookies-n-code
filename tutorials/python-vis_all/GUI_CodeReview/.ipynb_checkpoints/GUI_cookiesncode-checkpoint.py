...
parser = argparse.ArgumentParser(description="Example GUI for CookiesnCode @ CAS")
...
#Callback routines
def update_gui():
    codefeedback.text="Welcome to Cookies 'n' Code. Let's get started! You've loaded {0}.\n The columns are : {1}".format(args.csvfile,df.columns.values)
    data = filter_data()
